...
window.onload = function () {
  var old_date = '';
  var picker = js_datepicker__WEBPACK_IMPORTED_MODULE_1___default()('#date-picker', {
    alwaysShow: true,
    minDate: new Date(),
    dateSelected: new Date(),
    showAllDates: true,
    onSelect: function onSelect(picker, d) {
      var date = new Date(d);
  ...
  var selectCountry = document.getElementsByClassName('country-list');
  Array.prototype.forEach.call(selectCountry, function (s) {
    var c = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries;

    for (var C in c) {
      var option = document.createElement('option');
      option.value = C;
      option.innerHTML = "".concat(c[C].emoji, "   ").concat(c[C].name);
      s.appendChild(option);
    }
  });
  var crtShipBtn = document.getElementById('create-shipment-next');
  document.getElementById('back-step-2').addEventListener('click', function (e) {
    e.preventDefault();
    var step2 = document.getElementById('create-shipment-2');
    var step3 = document.getElementById('create-shipment-3');
    ...
    setTimeout(function () {
      ...
      var _final = document.querySelector('#final');

      misc.classList.remove('throw-off', 'hide');

      _final.classList.add('throw-off', 'hide');

      misc.classList.add('show');

      _final.classList.remove('show');
    }, 500);
  ...
  crtShipBtn.addEventListener('click', function (e) {
    e.preventDefault();
    ...
    function getQuotes() {
      ...
      var _final2 = document.querySelector('#final');

      misc.classList.add('hide');
      misc.classList.remove('show');

      _final2.classList.remove('throw-off');

      setTimeout(function () {
        misc.classList.add('throw-off');

        _final2.classList.remove('hide');

        _final2.classList.add('show');
      }, 500);
    ...
    function fromStep1() {
      var step1 = document.getElementById('create-shipment-1');
      var step2 = document.getElementById('create-shipment-2');
      var step2From = document.getElementById('step-2-from-label');
      var step2To = document.getElementById('step-2-to-label');
      var cCodeF = document.getElementById('from-country').value;
      var cCodeT = document.getElementById('to-country').value;
      step2From.innerHTML = "From ".concat(countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeF].emoji, " ").concat(countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeF].name);
      step2To.innerHTML = "To ".concat(countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeT].emoji, " ").concat(countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeT].name);
      document.getElementById('from-phone-code').value = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeF].phone;
      document.getElementById('to-phone-code').value = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeT].phone; //save data --from

      Shipment.from.country = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeF].name;
      Shipment.from.cc = cCodeF;
      Shipment.from.flag = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeF].emoji;
      Shipment.from.phone.code = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeF].phone;
      ...
      Shipment.from.zip = document.getElementById('from-zipcode').value; //save data --to

      Shipment.to.country = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeT].name;
      Shipment.to.cc = cCodeF;
      Shipment.to.flag = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeT].emoji;
      Shipment.to.phone.code = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCodeT].phone;
    ...
    function fromStep2() {
      ...
      var step2From = document.getElementById('step-2-from-label');
      var step2To = document.getElementById('step-2-to-label');
      var card = document.querySelector('.card-mid-divided');
      var cCodeF = document.getElementById('from-country').value;
      var cCodeT = document.getElementById('to-country').value;
      step2.classList.add('hide');
      step2.classList.remove('show');
      card.classList.remove('card-mid-divided'); //save data --from
      ...
      Shipment.from.email = document.getElementById('from-email').value; //save data --to
      ...
      Shipment.to.email = document.getElementById('to-email').value; //check if extra numbers have been added
      ...
      document.getElementById('summary-from-country').innerHTML = "".concat(Shipment.from.flag, " ").concat(Shipment.from.country);
      document.getElementById('summary-from-address').innerHTML = Shipment.from.address;
      document.getElementById('summary-from-csz').innerHTML = "".concat(Shipment.from.city, ", ").concat(Shipment.from.state, " ").concat(Shipment.from.zip);
  ...
  var addPhoneFromBtn = document.getElementById('add-phone-from');
  var addPhoneToBtn = document.getElementById('add-phone-to');
  addPhoneFromBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var cCode = document.getElementById('from-country').value;
    var aCode = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCode].phone;
    addPhone('from', aCode, document.getElementById('from-phone-area'));
  });
  addPhoneToBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var cCode = document.getElementById('to-country').value;
    var aCode = countries_list__WEBPACK_IMPORTED_MODULE_0___default.a.countries[cCode].phone;
  ...
  function addPhone(x, A, P) {
    ...
    set.code = i2;
    set.number = i3;
    set.ext = i4; //phone type

    fg1.classList.add('form-group');
    l1.classList.add('text-left', 'w-100');
    l1.setAttribute('for', "".concat(x, "-new-phone-type-").concat(counter));
    l1.innerHTML = '<small>Phone Type</small>';
    s1.classList.add('form-control', 'form-control-sm');
    s1.setAttribute('name', "".concat(x, "-new-phone-type-").concat(counter));
    s1.setAttribute('id', "".concat(x, "-new-phone-type-").concat(counter));
    ...
    mCont.appendChild(type); //phone code

    fg2.classList.add('form-group');
    l2.classList.add('text-left', 'w-100');
    l2.setAttribute('for', "".concat(x, "-new-phone-code-").concat(counter));
    l2.innerHTML = '<small>Code</small>';
    i2.classList.add('form-control', 'form-control-sm');
    i2.setAttribute('name', "".concat(x, "-new-phone-code-").concat(counter));
    i2.setAttribute('id', "".concat(x, "-new-phone-code-").concat(counter));
    i2.setAttribute('type', "text");
    i2.value = A;
    fg2.appendChild(l2);
    fg2.appendChild(i2);
    code.appendChild(fg2);
    mCont.appendChild(code); //phone

    fg3.classList.add('form-group');
    l3.classList.add('text-left', 'w-100');
    l3.setAttribute('for', "".concat(x, "-new-phone-code-").concat(counter));
    l3.innerHTML = '<small>Phone</small>';
    i3.classList.add('form-control', 'form-control-sm');
    i3.setAttribute('name', "".concat(x, "-new-phone-code-").concat(counter));
    i3.setAttribute('id', "".concat(x, "-new-phone-code-").concat(counter));
    i3.setAttribute('type', "text");
    fg3.appendChild(l3);
    fg3.appendChild(i3);
    phone.appendChild(fg3);
    mCont.appendChild(phone); //phone ext

    fg4.classList.add('form-group');
    l4.classList.add('text-left', 'w-100');
    l4.setAttribute('for', "".concat(x, "-new-phone-code-").concat(counter));
    l4.innerHTML = '<small>Extension</small>';
    i4.classList.add('form-control', 'form-control-sm');
    i4.setAttribute('name', "".concat(x, "-new-phone-code-").concat(counter));
    i4.setAttribute('id', "".concat(x, "-new-phone-code-").concat(counter));
    ...
    set.number = i3;
    set.ext = i4;
    globalCounters.phone["".concat(x, "Set")].push(set);
  }

  var psuedoBtn1 = document.getElementsByClassName('pseudo-btn-1');
  Array.prototype.forEach.call(psuedoBtn1, function (btn) {
    btn.addEventListener('click', function () {
      Array.prototype.forEach.call(psuedoBtn1, function (b) {
  ...
  function createBox() {
    ...
    var dI2 = document.createElement('input');
    var dI3 = document.createElement('input');
    var dT1 = document.createElement('i');
    var dT2 = document.createElement('i');
    ...
    bB.appendChild(bI);
    bB.innerHTML = "".concat(bB.innerHTML, " Delete");
