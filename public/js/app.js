  ...
  t.addEventListener('click', function () {
    ...
    switch (bt) {
      ...
      case 'blinker-item-4':
        ...
        summaryCountries();
        changeView();
        Object(jump_js__WEBPACK_IMPORTED_MODULE_1__["default"])('#summary-2', {
          offset: -100
        });
        break;
...
document.getElementById('summary-2-next').addEventListener('click', function (e) {
  ...
  if (x.dataset.state == 'next') {
    ...
    Object(jump_js__WEBPACK_IMPORTED_MODULE_1__["default"])('#summary-3', {
      offset: -100
    });
  } else {
    Array.prototype.forEach.call(document.getElementsByClassName('on-work'), function (w) {
...
document.getElementById('summary-3-next').addEventListener('click', function (e) {
  ...
  if (x.dataset.state == 'next') {
    ...
    Object(jump_js__WEBPACK_IMPORTED_MODULE_1__["default"])('#summary-4', {
      offset: -100
    });
  } else {
    x.innerHTML = 'next';
...
console.log(jump_js__WEBPACK_IMPORTED_MODULE_1__["default"]);
