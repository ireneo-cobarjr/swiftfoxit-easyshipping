<div class="row mt-5">
    <div class="col-md-12">
        <div class="packages-panel pr-3">
            <div style="background: white; padding: .8em">
                ...
                <div class="packages-panel-body">
                    ...
                    <div class="w-100 h-100 d-flex justify-content-end align-items-center mt-4">
                        <button class="btn btn-blue btn-sm" id="add-package"><i class="fas fa-plus-square"></i> Add Package</button>
                    </div>
                </div>
            </div>
        </div>
