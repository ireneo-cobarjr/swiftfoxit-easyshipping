            ...
            <div class="col-md-8 pt-5 pr-5 pl-0">
                <div class="delivery-details">
                    <div class="text-center d-inline-block p-2" style="width: 225px">
                        <span class="dd-head"><small>Delivery Date:</small></span><br>
                    ...
                    <div class="d-inline-block float-right" id="final-rate">
                        ...
                        <button class="btn btn-dark float-right" style="margin-top: -1.5rem; margin-right: 1rem;">Get Label</button>
                    </div>
                    <div id="delivered-on" class="text-center" style="width: 225px;"><small>Delivered by:</small><br> End of Day</div>
                </div>
            </div>
        </div>
    </div>
